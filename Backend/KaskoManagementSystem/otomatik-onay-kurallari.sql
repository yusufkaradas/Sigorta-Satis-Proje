...
FROM (VALUES
  ('AUTO_APPROVE_MAX_PREMIUM', N'Otomatik onay: en yüksek prim', N'Bu tutarın altındaki teklifler yönetici onayı olmadan satın alınabilir.', 150000.0),
  ('AUTO_APPROVE_MAX_MARKET_VALUE', N'Otomatik onay: en yüksek araç değeri', N'Bu değerin altındaki araçların teklifleri otomatik onaylanır.', 5000000.0),
  ('AUTO_APPROVE_MAX_CLAIMS', N'Otomatik onay: en fazla hasar', N'Hasar sayısı bu sınırı aşmayan müşterilerin teklifleri otomatik onaylanır.', 2.0),
